package edu.upc.eseiaat.pma.shopinglist;
...
import static edu.upc.eseiaat.pma.shopinglist.R.id.btn_add;
...
public class ShopingListActivity extends AppCompatActivity {
    ...
    private void maybeRemoveItem(final int pos) {
        ...
        builder.setMessage(String.format("Are you sure you want to remove %S ?",itemlist.get(pos)));
